...
class I18n {
  ...
  'filter.title': 'Filtry wydarzeń',
        ...
        'create.blikHelp': 'Numer telefonu do płatności BLIK ułatwi uczestnikom wpłacanie składek',
  ...
  'create.allowCompanion': 'Pozwól uczestnikom przyjść z osobą towarzyszącą (+1)',
  ...
  'filter.title': 'Event filters',
        ...
        'create.blikPlaceholder': '123456789',
        'create.blikHelp': 'Phone number for BLIK payments will make it easier for participants to pay fees',
