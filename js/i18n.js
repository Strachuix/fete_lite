  ...
  loadTranslations() {
    this.translations = {
      pl: {
        ...
        "home.noEventsDesc":
          "Utwórz swoje pierwsze wydarzenie i zacznij organizować spotkania!",
        ...
        "create.descriptionPlaceholder":
          "Opisz szczegóły wydarzenia, co będzie się działo...",
        ...
        "create.locationHelp":
          "Kliknij 📍 aby pobrać aktualną lokalizację lub 🗺️ aby wybrać na mapie",
        "create.selectLocationOnMap": "Wybierz lokalizację na mapie",
        "create.mapInstructions":
          "Kliknij na mapie aby wybrać lokalizację wydarzenia",
        "create.selectedLocation": "Wybrana lokalizacja:",
        "create.loadingAddress": "Ładowanie adresu...",
        "create.eventTheme": "Tematyka wydarzenia",
        "create.selectTheme": "Wybierz tematykę wydarzenia",
        ...
        "create.invitationHelp":
          "Udostępnij ten 8-znakowy kod znajomym aby mogli dołączyć",
        ...
        "create.foodRequirementsPlaceholder":
          "np. Opcje wegetariańskie, bezglutenowe, bez orzechów...",
        ...
        "create.organizerBlik": "Twój numer telefonu (do BLIK)",
        "create.blikPlaceholder": "123456789",
        "create.blikHelp":
          "Numer telefonu do płatności BLIK ułatwi uczestnikom wpłacanie składek",
        ...
        "create.allowCompanion":
          "Pozwól uczestnikom przyjść z osobą towarzyszącą (+1)",
        ...
        "create.dressCodeCustomPlaceholder":
          "np. Strój piracki, ubrania w kolorze czerwonym...",
        ...
        "create.accommodationInfoPlaceholder":
          "Opisz warunki noclegu, ilość miejsc, koszty...",
        ...
        // Tematyki wydarzeń
        "theme.birthday": "Urodziny",
        "theme.bbq": "Grill",
        "theme.boardgames": "Planszówki",
        "theme.bar": "Wyjście do baru",
        "theme.integration": "Integracja",
        "theme.karaoke": "Karaoke",
        "theme.cinema": "Kino",
        "theme.museum": "Muzeum",
        "theme.theater": "Teatr",
        "theme.minigolf": "Minigolf",
        "theme.concert": "Koncert",
        "theme.sport": "Sport/Aktywność",
        "theme.picnic": "Piknik",
        "theme.party": "Impreza",
        "theme.dance": "Potańcówka",
        "theme.other": "Inne",
        ...
        "share.codeDescription":
          "Inne osoby mogą użyć tego kodu do znalezienia wydarzenia",
        ...
        "details.inviteCode": "Kod zaproszenia",
        "details.copyInviteCode": "Skopiuj kod zaproszenia",
        ...
        "details.joinDescription":
          "Potwierdź, że chcesz dołączyć do tego wydarzenia:",
        "details.yourName": "Twoje imię",
        "details.yourEmail": "Twój email (opcjonalnie)",
        "details.bringCompanion": "Przyjdę z osobą towarzyszącą",
        ...
        "details.qrDescription":
          "Zeskanuj ten kod QR aby udostępnić wydarzenie",
        ...
        "details.editComingSoon":
          "Funkcja edycji wydarzeń będzie dostępna wkrótce.",
        "details.editWorkaround":
          "Na razie możesz utworzyć nowe wydarzenie z podobnymi danymi.",
        ...
        "notifications.permission":
          "Aby otrzymywać powiadomienia, musisz wyrazić zgodę w przeglądarce.",
        ...
        "error.eventNotFoundDesc":
          "Wydarzenie mogło zostać usunięte lub nie istnieje.",
        ...
        "validation.titleTooLong":
          "Nazwa wydarzenia jest za długa (max 100 znaków)",
        ...
        "ics.copyContent":
          "Skopiuj poniższą zawartość i zapisz jako plik .ics:",
        ...
        "network.offlineDescription":
          "Brak połączenia z internetem. Niektóre funkcje mogą być ograniczone.",
        ...
        "notifications.receiveReminders":
          "Otrzymuj przypomnienia o wydarzeniach",
        ...
        "sampleData.clearConfirm":
          "Czy na pewno chcesz usunąć wszystkie przykładowe wydarzenia?",
        ...
        "settings.description":
          "Organizuj wydarzenia towarzyskie szybko i prosto",
        ...
        "settings.clearDataConfirm":
          "Czy na pewno chcesz usunąć wszystkie wydarzenia? Tej operacji nie można cofnąć.",

        // Update system
        "update.available": "Dostępna aktualizacja!",
        "update.newVersionReady": "Nowa wersja {version} jest gotowa",
        "update.description":
          "Nowa wersja zawiera poprawki błędów i nowe funkcje.",
      ...
      en: {
        ...
        "home.noEventsDesc":
          "Create your first event and start organizing meetings!",
        ...
        "create.descriptionPlaceholder":
          "Describe event details, what will happen...",
        ...
        "create.locationHelp":
          "Click 📍 to get current location or 🗺️ to select on map",
        ...
        "create.eventTheme": "Event theme",
        "create.selectTheme": "Select event theme",
        ...
        "create.invitationHelp":
          "Share this 8-character code with friends so they can join",
        ...
        "create.foodRequirementsPlaceholder":
          "e.g. Vegetarian options, gluten-free, no nuts...",
        ...
        "create.organizerBlik": "Your phone number (for BLIK)",
        "create.blikPlaceholder": "123456789",
        "create.blikHelp":
          "Phone number for BLIK payments will make it easier for participants to pay fees",
        ...
        "create.allowCompanion": "Allow participants to bring a companion (+1)",
        ...
        "create.dressCodeCustomPlaceholder":
          "e.g. Pirate costume, red colored clothing...",
        ...
        "create.accommodationInfoPlaceholder":
          "Describe accommodation conditions, number of places, costs...",
        ...
        "theme.bbq": "BBQ",
        "theme.boardgames": "Board Games",
        "theme.bar": "Bar Night",
        "theme.integration": "Team Building",
        "theme.karaoke": "Karaoke",
        "theme.cinema": "Cinema",
        "theme.museum": "Museum",
        ...
        "theme.sport": "Sports/Activity",
        "theme.picnic": "Picnic",
        "theme.party": "Party",
        "theme.dance": "Dance Party",
        "theme.other": "Other",
        ...
        "details.copyInviteCode": "Copy invitation code",
        ...
        "details.bringCompanion": "I will bring a companion",
        ...
        "details.editComingSoon":
          "Event editing feature will be available soon.",
        "details.editWorkaround":
          "For now you can create a new event with similar data.",
        "details.close": "Close",
        ...
        "notifications.permission":
          "To receive notifications, you need to grant permission in the browser.",
        ...
        "error.eventNotFoundDesc":
          "Event may have been deleted or does not exist.",
        ...
        "validation.titleTooLong":
          "Event name is too long (max 100 characters)",
        ...
        "notifications.permissionDeniedHelp":
          "Notifications have been blocked. Unblock them in browser settings.",
        "notifications.permissionHelp":
          "To receive notifications, you need to grant permission in the browser.",
        "notifications.test": "Test notification",
        "notifications.testMessage":
          "This is a sample notification from Fete Lite!",
        "notifications.eventStarting": "Event starting soon",

        // Sample data
        "sampleData.title": "Sample data",
        "sampleData.description":
          "Load sample events to test app functionality.",
        ...
        "sampleData.clearConfirm":
          "Are you sure you want to remove all sample events?",
        ...
        "update.description":
          "New version includes bug fixes and new features.",
